...
//    Serial.println(data);
    buttons = data[0];
    potentiometer1 = data[1];
    potentiometer2 = data[2];
    
    
    myservo1.write(potentiometer1);
    myservo2.write(potentiometer2);
...
void angry(){
  strip.setPixelColor(16, 255, 0, 50);
  strip.setPixelColor(17, 255, 0, 50);
  strip.setPixelColor(18, 255, 0, 50);
  strip.setPixelColor(21, 255, 0, 50);
  strip.setPixelColor(22, 255, 0, 50);
  strip.setPixelColor(23, 255, 0, 50);
  strip.setPixelColor(24, 255, 0, 50);
  strip.setPixelColor(26, 255, 0, 50);
  strip.setPixelColor(27, 255, 0, 50);
  strip.setPixelColor(28, 255, 0, 50);
  strip.setPixelColor(29, 255, 0, 50);
  strip.setPixelColor(31, 255, 0, 50);
  strip.setPixelColor(32, 255, 0, 50);
  strip.setPixelColor(33, 255, 0, 50);
  strip.setPixelColor(34, 255, 0, 50);
  strip.setPixelColor(37, 255, 0, 50);
  strip.setPixelColor(38, 255, 0, 50);
  strip.setPixelColor(39, 255, 0, 50);
  strip.setPixelColor(50, 255, 0, 50);
  strip.setPixelColor(51, 255, 0, 50);
  strip.setPixelColor(52, 255, 0, 50);
  strip.setPixelColor(53, 255, 0, 50);
  for (int i=64; i<75; i++){
